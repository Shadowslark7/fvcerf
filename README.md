...
3. У вас 10 джобов на 8 воркеров... Выберите лучший из 10x8 возможных вариантов, выберите следующий из 9x8 вариантов... 10!x8^10 = 3.7x10^16. NP hard.
4. Это [CAP-теорема](https://en.wikipedia.org/wiki/CAP_theorem) - если кратко.
5. Если программе не хватает 640kb, значит она не может отскейлиться на другие машины. И тогда ей наступает пизда.
