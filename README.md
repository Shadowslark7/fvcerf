...
* Writer node хуячит данные из сокета ~~~в файл~~~ на диск и форвардит данные дальше по сети.
...
* Почему так? Потому что, когда нужно что-то сохранить, возникает два самых сложных вопроса: какое имя будет у файла и в какую директорию его положить. И это не забота этого сервиса.
